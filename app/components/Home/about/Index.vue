...
<template>
       <section id="about" :class="twMerge('flex justify-center sm:my-0 my-20 flex-col items-center gap-y-10', $attrs.class as string)">
        <div class="flex justify-center items-center gap-4 flex-col">
          ...
          <q id="me" aria-labelledby="who-i-am about-me" style="quotes: none;" :class="['text-balance font-lato  text-center text-lg shadow-md sm:text-xl leading-relaxed border-2 border-double xl:px-2.5 px-5 py-14.5 sm:py-18 md:py-20 rounded-lg hover:shadow-lg transition-shadow', {'opacity-0' : observe}]" v-html="about"/>
