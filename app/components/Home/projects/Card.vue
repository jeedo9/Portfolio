...
<template>
    ...
    <div class="flex flex-col justify-center items-start gap-y-6 ">
            ...
            <div class="flex justify-center items-center gap-x-2">
              <UiButtonsButtionIcon :to="view.githubLink" class="*:hover:scale-107" tag="link" icon-name="mynaui:brand-github" icon-slug="github" />

            <UiButtonsButtionIcon :to="view.liveLink" :class="['*:hover:scale-107', {'disabled': !view.isLive()}]" tag="link" icon-name="mynaui:external-link" icon-slug="external link" />
