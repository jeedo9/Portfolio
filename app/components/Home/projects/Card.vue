...
<template>
    ...
    <div class="flex flex-col justify-center items-start gap-y-6 ">
            ...
            <div :class="['flex flex-col justify-center items-start md:items-end w-full pl-2 md:pr-2', {'gap-y-4.5 md:gap-y-2': stack.slice(maxStack).length, 'gap-y-6': !stack.slice(maxStack).length}]">
