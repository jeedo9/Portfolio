...
<template>
    <button :type :aria-controls="ariaControls" v-bind="rest" :aria-expanded="open" :aria-label="ariaLabel" :class="twMerge('flex justify-center items-end group flex-col md:hidden w-5 h-1/4 relative', $attrs.class as string)"> 
