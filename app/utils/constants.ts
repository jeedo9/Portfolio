...
export {IS_MOBILE_KEY, AUTHOR_NAME, DEFAULT_DELAY, DEFAULT_DELAY_UNITY, MAIL, GITHUB, LINKEDIN, SCHOOL, SCHOOL_LINK, WEBSITE_NAME, WEBSITE_DESCRIPTION, AUTHOR_LASTNAME}