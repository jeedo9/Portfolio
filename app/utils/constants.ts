...
export {IS_MOBILE_KEY, MD, LG,WEBSITE_URL,DEVELOPMENT_URL, PRODUCTION_URL,AUTHOR_NAME, DEFAULT_DELAY, DEFAULT_DELAY_UNITY, MAIL, GITHUB, LINKEDIN, SCHOOL, SCHOOL_LINK, WEBSITE_NAME, WEBSITE_DESCRIPTION, AUTHOR_LASTNAME}